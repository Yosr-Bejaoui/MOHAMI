"""Extract the Code de Commerce into code_commercial.json."""
...
def main() -> None:
    pdf_path = project_root / "data" / "sources" / "commercial_code" / "CODE DE COMMERCE.pdf"
    output_json = project_root / "data" / "generated" / "code_commercial.json"
